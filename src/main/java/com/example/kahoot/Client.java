...
public class Client extends Application {
    ...
    public void start (Stage stage) throws Exception {
        ...
        ImageView pinCode = new ImageView("C:\\Kahoot\\src\\main\\java\\com\\example\\kahoot\\resources\\img\\pincode.png");
        ...
        tfPin.setOnAction(e -> {
            if (!tfPin.getText().contains("null")) {
                ImageView nicknamePng = new ImageView("C:\\Kahoot\\src\\main\\java\\com\\example\\kahoot\\resources\\img\\pincode.png");
                Pane pane = new Pane();
                ...
                Pane pane = new Pane();
                ImageView restart = new ImageView("C:\\Kahoot\\src\\main\\java\\com\\example\\kahoot\\resources\\img\\restart.jpg");
